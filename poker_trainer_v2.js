...
function startTraining(mode, trainingType = 'basic') {
    ...
    // 如果不是陷阱、GTO、all或data训练，从phase中提取问题
    if (trainingType !== 'traps' && trainingType !== 'gto' && trainingType !== 'all' && trainingType !== 'data') {
...
const DATA_MEMORY = [
    ...
    },
    {
        ...
        questions: [
            ...
            { q: "MDF计算公式？", a: "MDF = 下注额 ÷ (底池 + 下注额)" },
            { q: "对手下注50% pot，你的MDF是多少？", a: "50/(100+50) = 33%，你需要防守67%" },
            { q: "对手下注75% pot，你的MDF是多少？", a: "75/(100+75) = 43%，你需要防守57%" },
            { q: "对手下注100% pot（pot-sized bet），你的MDF？", a: "100/(100+100) = 50%，你需要防守50%" },
            { q: "对手Overbet 150% pot，你的MDF？", a: "150/(100+150) = 60%，你只需防守40%（可弃更多）" },
